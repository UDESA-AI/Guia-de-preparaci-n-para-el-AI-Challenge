...
5. En la pestaña "Installs" de UnityHub clickear el botón "Install Editor", e instalar la versión "2020.3.36f1 (LTS)" en "Official releases". Si no está disponible, puede buscarlo en la página de [Download Archive](https://unity.com/releases/editor/archive) o clickear el siguiente link [2020.3.36f1@unityhub](unityhub://2020.3.36f1/71f96b79b9f0) que descargará directamente la versión en UnityHub.
