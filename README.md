...
5. En la pestaña "Installs" de UnityHub clickear el botón "Install Editor", e instalar la versión "2020.3.36f1 (LTS)" en "Official releases". Si no está disponible, puede buscarlo en la página de [Download Archive](https://unity.com/releases/editor/archive).
