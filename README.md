...
5. Abrir la página con las versiones de Unity para instalar [Download Archive](https://unity.com/releases/editor/archive) y elegir la versión "Unity 2020.3.36" tocando el botón azul "Unity Hub". Esto abrirá el Unity Hub y ahí instalaremos la versión 2020.3.36f1. 
